<?php 
	$page_title = "Generator Fuel Guide";
	$page_description = "'What generator fuel is best for me?'";
	$page_keywords = "'Generators fuel'";
...
<div class="content">
	<div class="article">
		...
		<h2>Fuel Types:<br>Advantages &amp; Disadvantages</h2>

		<h3><img src="/images/icons/gas.svg" alt="Gasoline pump icon">Gasoline</h3>
		...
		<h3 class="diesel"><img src="/images/icons/gas.svg" alt="Diesel pump icon">Diesel</h3>
		...
		<h3><img src="/images/icons/propane.svg" alt="Propane bottle icon">Propane</h3>
		...
		<h3><img src="/images/icons/naturalgas.svg" alt="Propane bottle icon">Natural Gas</h3>
		...
		<h2>Tri-fuel &amp; Dual fuel
			<br>
			<img src="/images/icons/gas.svg" alt="Gasoline pump icon">
			<img src="/images/icons/propane.svg" alt="Propane bottle icon">
			<img src="/images/icons/naturalgas.svg" alt="Propane bottle icon">
		</h2>
		...
		<h3><img src="/images/icons/funnel.svg" alt="Funnel icon">Fuel stabiliser</h3>
		...
		<h3><img src="/images/icons/ice.svg" alt="Ice icon">Extreme weather</h3>
